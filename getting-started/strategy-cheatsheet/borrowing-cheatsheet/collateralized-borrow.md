...
Borrow against your collateralized tokens in a single transaction. You earn supply interest on the token lent while being charged a borrow interest on the token borrowed.&#x20;
...
* Input a borrow amount which leaves a buffer for any price fluctuations.
